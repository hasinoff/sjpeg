...
// points into it, so trellis quantization would silently re-decide against the
// optimized codes and stop matching the histogram those tables were built from.
